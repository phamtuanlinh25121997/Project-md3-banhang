...
//                "Mã sản phẩm", "Tên sản phẩm", "Giá", "Mô tả", "3Trong kho", "Thương hiệu")
//                + "\n"
...
//    }
    @Override
    public String toString() {
        return "| Mã sản phẩm |                  Tên sản phẩm                 |      Giá     |                                           Mô tả                                         | Trong kho   | Thương hiệu |\n"
                + "|-------------|-----------------------------------------------|--------------|-----------------------------------------------------------------------------------------|-------------|-------------|\n"
                + String.format("| %-11s | %-45s | %-12s | %-87s | %-11s | %-11s |\n",
                productId, productName, productPrice + " $", description, stock + " máy", trademark.getTrademarkName())
                + "\nTình trạng: " + (status ? "Bán" : "hết hàng") + "\n";
    }
